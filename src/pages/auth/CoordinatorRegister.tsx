...
export default function CoordinatorRegister() {
  ...
  return (
    <AuthLayout
      ...
      subtitle="JNTU-GV Vizianagaram Event Coordinator Access"
      roleBadge="COORD"
      footerLinkText="Already have a Coordinator account?"
      footerLinkTo="/coordinator-login"
    >
      <form className="space-y-4" onSubmit={handleSubmit}>
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              className="block w-full pl-9 pr-3 py-2.5 bg-gray-50/50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#F26522] focus:bg-white text-xs font-medium text-gray-900"
          ...
          <div>
            ...
            <div className="relative">
              ...
              <select
                ...
                className="block w-full pl-9 pr-2 py-2.5 bg-gray-50/50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#F26522] focus:bg-white text-xs font-medium text-gray-900 cursor-pointer"
              >
        ...
        >
          {isLoading ? (
            ...
            <>
              <TextRoll text="Create Coordinator Account" />
